...
class Calc {
    ...
    public static String parse(String expression) throws Exception {
        ...
        //если одни число римское, а другое - арабское
            ...
            throw new Exception("Числа должны быть либо арабские либо римские.");
        }
        ...
        if (isRoman) {
            //если римское число получилось меньше либо равно нулю, выдаем ошибку,так как римских отрицательных чисел нет как и нуля.
            if (arabian <= 0) {
...
class Roman {
    static String[] romanArray = new String[]{"N", "I", "II", "III", "IV", "V", "VI", "VII", "VIII", "IX", "X", "XI",
